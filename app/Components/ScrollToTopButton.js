...
function ScrollToTopButton() {
  ...
  return (
    <button
      onClick={() => scrolltoTop()}
      id="topButton"
      className="fixed bottom-10 right-10 z-10 animate-bounce rounded-full bg-gray-100 md:w-16 md:h-16 w-12 h-12 hidden justify-center items-center shadow-md"
    >
